...
greedy_move(game_state(B1, B2, player2, S, _D1, _D2), Move):-
    ...
    write(CurrentScore1),nl,
    write(CurrentScore2),nl,
    (CurrentScore1 = 0 -> NewScore is 0.5; NewScore = CurrentScore1).
    write('pesca1'),nl,
    Ratio is CurrentScore2/NewScore,
    write(Ratio),nl,
    ...
    ;   
        (
            ...
            min_member(MinScore-Move1, ScoreMoves1),
            write(MinScore),nl, write(Ratio),nl,
            MinScore < Ratio -> Move = Move1  
        ;
            write('Greedy'),nl,
...
greedy_move(game_state(B1, B2, player1, S, _D1, _D2), Move):-
    ...
    board_score(B1, CurrentScore1),
    board_score(B2, CurrentScore2),
    (CurrentScore2=0->CurrentScore2 is 0.5; CurrentScore2=CurrentScore2),
    Ratio is CurrentScore1/CurrentScore2,
    max_member(Score1-Move1, ScoreMoves1),
    write(Score1),nl,
    (  
        Score1 > Ratio -> Move = Move1  
